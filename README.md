...
- [02 - Cafe business scenario](02-coffee-shop-scenario/README.md)
- [03 - Roles, Commands, and Events Mapping](03-roles-commands-events-mapping/README.md)
  - [Key Business events in the coffeeshop](03-roles-commands-events-mapping/README.md#key-business-events-in-the-coffeeshop)
  - [Commands and Events mapping](03-roles-commands-events-mapping/README.md#commands-and-events-mapping)
  - [Roles](03-roles-commands-events-mapping/README.md#roles)
  - [Exceptions or risky events](03-roles-commands-events-mapping/README.md#exceptions-or-risky-events)
  - [Re-think solutions to serve risky events](03-roles-commands-events-mapping/README.md#re-think-solutions-to-serve-risky-events)
  - [Aggregate](03-roles-commands-events-mapping/README.md#aggregate)
  - [Bounded Context forming up](03-roles-commands-events-mapping/README.md#bounded-context-forming-up)
- [04 - Modeling and Development](04-modeling-and-development/README.md)
  - [Specification by Example](04-modeling-and-development/README.md#specification-by-example)
  - [TDD within Unit Test environment](04-modeling-and-development/README.md#tdd-within-unit-test-environment)
  - [Generate unit test code skeleton](04-modeling-and-development/README.md#generate-unit-test-code-skeleton)
  - [Implement Domain Model from code Skeleton](04-modeling-and-development/README.md#implement-domain-model-from-code-skeleton)
  - [Running on AWS](04-modeling-and-development/README.md#running-on-aws)
  - [Design each Microservices in Port-adapter concept](04-modeling-and-development/README.md#design-each-microservices-in-port-adapter-concept)
  - [Running on AWS](04-modeling-and-development/README.md#running-on-aws)
<!---
