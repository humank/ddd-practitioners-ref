...
**Updated @ 2019-12-17. Appreciate to have your watch and stars, now this workshop has been officially merged into [aws-samples/designing-cloud-native-microservices-on-aws](aws-samples/designing-cloud-native-microservices-on-aws), all of the un-resolved reserach and imeplementation will also merge too, wellcome to keep going watch and star the new repo.**
