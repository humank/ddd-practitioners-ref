...
export declare class AccountAccessKeyCache {
     ...
     * @param resolver
     */
    fetch(accessKeyId: string, resolver: () => Promise<string | undefined>): Promise<string | undefined>;
    /** Get the account ID from an access key or undefined if not in cache */
    get(accessKeyId: string): Promise<string | undefined>;
    /** Put a mapping betweenn access key and account ID */
    put(accessKeyId: string, accountId: string): Promise<void>;
    private loadMap;
    private saveMap;
}
